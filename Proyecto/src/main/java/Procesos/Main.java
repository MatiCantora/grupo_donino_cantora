...
public class Main {
    ...
    public static void main(String[] args) {
        Torneo torneo = new Torneo(ListaPartidos("..\\grupo_donino_cantora\\Proyecto\\resources\\Archivos\\ResultadosPartidos.csv"));
        PronosticosResultado pronosticoJuego = new PronosticosResultado(torneo,ListaJugadores("..\\grupo_donino_cantora\\Proyecto\\resources\\Archivos\\PronosticosJugador1.csv"));
